...
I am Esi Ogagaoghene, and I love coding! I'm a ***Full-Stack Developer*** skilled in HTML, CSS, JavaScript, React.js framework, Ruby, Ruby on Rails, database management systems, and AWS Cloud DevOps. I look forward to contribute to be part of a world-class developers building interesting large-scale web applications. I hold a Master's degree in Computer Science. I'm comfortable working with any technology stack. I enjoy using my analytical and creative ability to solve complex problems.  I am open to new opportunities! You can reach me via email at [esi.ogagaoghene@yahoo.com](mailto:esi.ogagaoghene@yahoo.com).
